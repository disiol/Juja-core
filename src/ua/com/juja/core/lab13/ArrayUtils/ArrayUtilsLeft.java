 ...
 * Если таких отрезков несколько - вернуть самый левый.
 ...
 * lookFor([0, -1, 0, -1]) = [] // отсутствуют положительные числа -1, 0, -1]) = [] // отсутствуют положительные числа
 */

public class ArrayUtilsLeft {
